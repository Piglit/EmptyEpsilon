...
mkdir ee
cd ee
git clone --depth 1 -b lan2021 https://github.com/piglit/emptyepsilon
git clone --depth 1 -b lan2021 https://github.com/piglit/seriousproton
cd emptyepsilon
mkdir _build
cd _build
