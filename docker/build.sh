...
GIT_REF_NAME_LIST=( "${GITHUB_HEAD_REF}" "${GITHUB_BASE_REF}" "${GITHUB_REF}" "shattered_horizon24" )
...
do
  ...
  SERIOUS_PROTON_BRANCH="shattered_horizon"
...
git clone --depth=1 -b "${SERIOUS_PROTON_BRANCH}" https://github.com/Piglit/SeriousProton.git "${PROJECT_DIR}"/SeriousProton
