...
pc1 = FactionInfo():setName("Transport1")
pc1:setGMColor(128, 255, 128)
pc1:setDescription(_([[Transport craft from Endor]]))

pc2 = FactionInfo():setName("Transport2")
pc2:setGMColor(128, 255, 128)
pc2:setDescription(_([[Transport craft from Endor]]))
pc2:setFriendly(pc1)

pc3 = FactionInfo():setName("Transport3")
pc3:setGMColor(128, 255, 128)
pc3:setDescription(_([[Transport craft from Endor]]))
pc3:setFriendly(pc1)
pc3:setFriendly(pc2)
...
enemies:setEnemy(pc1)
enemies:setEnemy(pc2)
enemies:setEnemy(pc3)

natural = FactionInfo():setName("Environment")
natural:setGMColor(128, 128, 128)
natural:setDescription(_([[Debris flying around.]]))
natural:setEnemy(pc1)
natural:setEnemy(pc2)
natural:setEnemy(pc3)
...
alliance2 = FactionInfo():setName("Rebel Alliance")
alliance2:setGMColor(255, 128, 128)
alliance2:setDescription(_([[The Rebel Alliance]]))
alliance2:setEnemy(imp)
--alliance2:setFriendly(alliance)
