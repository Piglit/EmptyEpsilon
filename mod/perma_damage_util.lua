local ENABLE_DAMAGE_LOG = false	-- feature flag for ship damage - cross-check with player_ships_util ENABLE_LOG 
...
if ENABLE_DAMAGE_LOG then
	...
	function perma_damage_util:sendDamageReport(ship)
		print("Warning: log is enabled, but damage report is not.")
	end
end
