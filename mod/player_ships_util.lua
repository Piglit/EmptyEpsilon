...
--	{"Spite",				"HWK-290 ",		"Sehr alter leichter Frachter HWK-290 von Seris Veynar"},
	{"Still Moving",		"GX1 ",			"GX1 Short Hauler von Fever Jun"},
...
--	{"Zegema Beach",		"Gozanti Mk Ic",	"Gozanti von Gabber'lok"},
	...
	upgrades_by_ship = {
		["Batnor Senaar"] = {["Laser"]=2},
		["Beacon Runner"] = {["Laser"]=1},
		["Cropdust Nomad"] = {["Laser"]=1, ["Antrieb"]=1, ["Kühlung"]=1},
		["Greedy Wampa"] = {["Schild"]=2, ["Antrieb"]=2, ["Laser"]=2},
		["H.I.V.E."] = {["Schild"]=1, ["Antrieb"]=1},
		["Last Dawn"] = {["Manöver"]=1},
		["Parsec Twister"] = {["Laser"]=2, ["Droiden"]=1, ["Schild"]=1},
		["Thunderbolt"] = {["Laser"]=1, ["Droiden"]=1},
		["Udesla"] = {["Schild"]=2},
	},
	possible_upgrades = {
		"Laser",
