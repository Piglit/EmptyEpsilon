...
for cnt=1,5 do
    template = ShipTemplate():setName("Personnel Freighter " .. cnt):setLocaleName(string.format(_("ship", "Personnel Freighter %d"), cnt)):setClass(_("class", "Corvette"), _("subclass", "Freighter")):setModel("transport_1_" .. cnt)
	...
	template:setDockClasses(_("class", "Starfighter"), _("class", "Freighter"), _("class", "Cruiser"), _("class", "Shuttle"))
    ...
    template = ShipTemplate():setName("Goods Freighter " .. cnt):setLocaleName(string.format(_("ship", "Goods Freighter %d"), cnt)):setClass(_("class", "Corvette"), _("subclass", "Freighter")):setModel("transport_2_" .. cnt)
    ...
    template = ShipTemplate():setName("Garbage Freighter " .. cnt):setLocaleName(string.format(_("ship", "Garbage Freighter %d"), cnt)):setClass(_("class", "Corvette"), _("subclass", "Freighter")):setModel("transport_3_" .. cnt)
    ...
    template = ShipTemplate():setName("Equipment Freighter " .. cnt):setLocaleName(string.format(_("ship", "Equipment Freighter %d"), cnt)):setClass(_("class", "Corvette"), _("subclass", "Freighter")):setModel("transport_4_" .. cnt)
    ...
    template = ShipTemplate():setName("Fuel Freighter " .. cnt):setLocaleName(string.format(_("ship", "Fuel Freighter %d"), cnt)):setClass(_("class", "Corvette"), _("subclass", "Freighter")):setModel("transport_5_" .. cnt)
...
template = ShipTemplate():setName("Jump Carrier"):setLocaleName(_("ship", "Jump Carrier")):setClass(_("class", "Corvette"), _("subclass", "Freighter")):setModel("transport_4_2")
...
variation = template:copy("Benedict"):setLocaleName(_("playerShip", "Benedict")):setType("playership"):setClass(_("class", "Corvette"), _("subclass", "Freighter/Carrier"))
...
template:setTubeDirection(1,  0):setTubeSize(1,"medium"):setTubeLoadTime(1, 8):weaponTubeDisallowMissle(1, "Mine")
template:setTubeDirection(2,-90):setTubeSize(2, "large"):setTubeLoadTime(2,12):setWeaponTubeExclusiveFor(2,"HVLI"):weaponTubeAllowMissle(2,"Homing")
template:setTubeDirection(3, 90):setTubeSize(3, "large"):setTubeLoadTime(3,12):setWeaponTubeExclusiveFor(3,"HVLI"):weaponTubeAllowMissle(3,"Homing")
template:setTubeDirection(4,180):setTubeSize(4,"medium"):setTubeLoadTime(4,10):setWeaponTubeExclusiveFor(4,"Mine")
template:setWeaponStorage("Homing", 8)
template:setWeaponStorage("Nuke",   4)
template:setWeaponStorage("Mine",   6)
template:setWeaponStorage("EMP",    6)
