...
template:setWeaponTubeExclusiveFor(1, "laser_green")
template:setWeaponStorage("laser_green", 99)
...
template:setTubes(3, 10)
template:setTubeSize(2, "small")
template:setTubeSystem(0, "beamweapons")
template:setTubeSystem(1, "beamweapons")
template:setWeaponTubeExclusiveFor(0, "laser_green")
template:setWeaponTubeExclusiveFor(1, "laser_green")
template:weaponTubeDisallowMissle(2, "laser_green")
template:weaponTubeDisallowMissle(2, "laser_red")
template:setTubeLoadTime(0, 1) 
template:setTubeLoadTime(1, 1) 
template:setWeaponStorage("laser_green", 99)
template:setWeaponStorage("Homing", 8)	-- other loadout by GM
template:setCombatManeuver(250, 150)
template:setEnergyStorage(400)
template:setRepairCrewCount(1)
template:setLongRangeRadarRange(15000)
template:setShortRangeRadarRange(5000)
template:setCanScan(true)
template:setCanHack(false)
template:setCanDock(true)
