...
model:setRenderOffset(2, 0, 5)
model:setScale(10)
--model:setRadius(300)
--model:setCollisionBox(400, 400)
model:setRadius(300)
model:setCollisionBox(20.5 * 2 * 10, 18 * 2 * 10)
...
model:setRenderOffset(-11, 2, 5)
model:setRadius(1125)
model:setCollisionBox(29 * 2 * 20, 24 * 2 * 20)
...
model:setRadius(1100) -- fix oversized radar icon (until a better icon is provided, reflecting the 'bay')
...
model:setRenderOffset(-4.5, 0, 6)
model:setRadius(1875)
model:setCollisionBox(20 * 2 * 56, 20 * 2 * 52)
