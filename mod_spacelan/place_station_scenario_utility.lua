...
function placeStation(x,y,name,faction,size,diagnostic)
	...
	station.size_factor = station_size_number[station:getTypeName()]
	...
	station.comms_data.system_repair = {
		["reactor"] =		{cost = math.random(11,19),	max = random(.7, .85),	avail = random(1,100) <= chance},
		["beamweapons"] =	{cost = math.random(11,19),	max = random(.6, .85),	avail = random(1,100) <= chance},
		["missilesystem"] =	{cost = math.random(11,19),	max = random(.6, .85),	avail = random(1,100) <= chance},
		["maneuver"] =		{cost = math.random(11,19),	max = random(.7, .85),	avail = random(1,100) <= chance},
		["impulse"] =		{cost = math.random(11,19),	max = random(.6, .85),	avail = random(1,100) <= chance},
		["warp"] =			{cost = math.random(11,19),	max = random(.6, .85),	avail = random(1,100) <= chance},
		["jumpdrive"] =		{cost = math.random(11,19),	max = random(.6, .85),	avail = random(1,100) <= chance},
		["frontshield"] =	{cost = math.random(11,19),	max = random(.7, .85),	avail = random(1,100) <= chance},
		["rearshield"] =	{cost = math.random(11,19),	max = random(.7, .85),	avail = random(1,100) <= chance},
	}
