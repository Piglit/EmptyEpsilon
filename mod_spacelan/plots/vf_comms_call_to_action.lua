...
function vf_comms_call_to_action:init()
	...
	self.randomEffects = {
		arlenianStation = {
		[[Greetings, Human captain. This is Arlenian station {callsign} in sector {sector} requesting communication.
...
We ask for your assistance in preserving this life. Cooperation between our peoples may prevent an unnecessary loss.]],
		...
		kraylorBase = {[[[Incoming Kraylor Military Transmission]
Unknown vessel.
...
Kraylor Command has assumed operational assessment of this contact. End communication.]],
		[[[Incoming Kraylor Military Transmission]
Unknown vessel.
...
Prepare yourself, Human. The battle begins.]],
		[[Human captain, your vessel has crossed into our hunting grounds.
...
Let the stars witness the strength of your crew. Let this battle decide whose steel is stronger.]],
		[[Human captain, we have found a challenger among the stars.
...
Come, Human. Let us see if your courage burns as brightly as your guns.]]
		...
		exuariAmbush = {
		[[Human captain. This is an Exuari war call.
...
Fight well, Human. A warrior's last moments should be worthy of remembrance. The hunt has begun.]],
		[[Human captain. You are hearing the voice of the Exuari.
...
The Exuari have come. Your battle ends here.]],
		[[Human captain. The Exuari are speaking.
...
The Exuari strike now.]],
		...
		conflictExuari = {
		[[Human captain! This system burns with the fires of battle. You will choose: stand with true warriors or cower in the shadow of prey. Join our hunt - prove your strength, take glory, and strike down those weak fools who threaten us. This fight is your chance for honor and victory!]],
		[[Human captain! Your presence in this battleground is noted. Do you seek glory and honor? Join us in the hunt and clash with worthy foes. Show your courage and make war your art! Stand with us or flee - there is no third way!]],
		},
		ktlitanQueen = {
		[[[Translated Ktlitan Transmission]
...
Execution continues.]],
		...
		pirateStation = {
		[[Well, look what drifted into our corner of space.
...
Choose your next move carefully. Out here, mistakes tend to become permanent.]],
		[[Human Navy vessel, your arrival has been noticed.
...
Your presence here is unwanted. So may our response be.]],
		[[Human Navy captain, looks like you almost found something you were not looking for.
...
Do not mistake our patience for weakness. Some mistakes only happen once.]],
		...
		mineThrowerDance = {
		[[Ah, a noble vessel of the Navy approaches - how quaint.
...
My reputation's on the line, and I do love a good reputation. So do yourself a favor and consider this your last polite offer before I turn your patrol into a fireworks show. Trust me, I don't like to waste my inventions - so I suggest you make your move wisely.]],
		...
		conflictCriminals = {
		[[Captain, looks like you stumbled right into the middle of a mess. A few factions are tearing this system apart, and there's profit to be had if you pick a side. We say join us - better to be on the winning end of the deal than floating wreckage. What do you say? We can make this worth your while... but make no mistake, hesitation has its price.]],
		[[Hey, Captain! Looks like you dropped into a hell of a scrap. Best bet? Pick a side quick and make some credits while you're at it. We don't do courtesy calls - just business. You with us, or you just another target? Think fast.]],
		},
		hiddenArtifact = {
		[[Greetings, Captain. You have approached a mining operation within this area of space. Our crews are currently engaged in extensive operations, including a careful search for a high-value artifact recently detected in the belt. We welcome your presence and cooperation, as station security and safe passage benefit all in this contested area. Maintaining open communication ensures mutual benefit and continued prosperity for all parties involved.]],
		[[Greetings, Captain. We are currently conducting extraction operations within this asteroid belt and searching for a valuable artifact rumored to be hidden nearby. Our crews keep a sharp eye on any approaching vessels - expecting no trouble, but ready for it.]],
		[[Greetings, Captain. Recent reports indicate increased pirate activity in the sector. We advise caution in your travels. Our crews continue extraction operations nearby and maintain vigilance against threats. Trust that your reputation as a capable navigator will serve you well in these troubled areas of space.]],
		},
		collapseArtifact = {
		[[Captain, we are an independent science station.
...
The black hole ahead is contained by a powerful artifact. Should this containment fail, expect significant gravitational disruption. Your vessel risks exposure to intense spatial forces capable of compromising operational integrity. Maintain alertness and prepare for rapid response to abnormal conditions.]],
		...
		nebulaCoolantGain = {
		[[Hey there, Captain. You're heading into some nebulae that are perfect for topping up your coolant. No catch - just a friendly heads-up from a station that's seen its share of ships make the run. If you need supplies or a quick deal, you know where to find us. Safe travels out there.]],
		[[Captain, you're entering nebulae rich in coolant. That fluid is ours, and we don't take kindly to strangers using it for free. If you want a share, be ready to defend yourself. Don't mistake our patience for weakness.]],
		},
		nebulaCoolantDrain = {
		[[Captain, you've got a heads-up: those nebulae ahead will play havoc with your cooling systems. Best keep an eye on your temps or things could get messy.]],
		[[Hey captain, just so you know, that nebula up ahead messes with cooling systems - your ship's gonna feel the heat. Watch your gauges, no need to make trouble when that little info could save your hull.]],
		},
		instableWormhole = {
		[[Captain, you're approaching an unstable wormhole. It can be passed, but expect complications along the way. Just thought you should know before you get too close. Keep your crew sharp and your ship ready - this won't be a simple trip.]],
		[[Captain, the wormhole ahead is navigable. Passage is possible; however, it carries inherent risks and unpredictable complications. Proceed with full awareness of potential challenges. Maintain vigilance and preparedness for any anomalies encountered.]],
		},
	}
	self.effectIndex = {}
end
			...
			for _,ship in ipairs(players) do
				if distance(cta.source, ship) <= cta.radius then
					if cta.source:sendCommsMessageNoLog(ship, self:replace_message_placeholders(cta.message, cta.source, ship)) then
						...
						ship:addToShipLog(string.format("Received transmission from %s from direction %i", cta.source:getCallSign(), math.floor(arc)), "cyan")
