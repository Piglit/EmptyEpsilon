...
function wh_rota:add_object(object, speed, center, center_y)
	...
	object.angle = angleRotation(x2, y2, x1, y1)
	object.distance = distance(x2, y2, x1, y1)
	object.speed = speed
...
function wh_rota.set_center(object, x,y)
	...
	if object.center == nil then
		object.center = {x, y}
		object.center.getPosition = function(self)
			return self[1], self[2]
		end
	else
		object.center[1], object.center[2] = x, y
	end
   	assert (object.center:getPosition() ~= nil)
   	assert (object:getPosition() ~= nil)
