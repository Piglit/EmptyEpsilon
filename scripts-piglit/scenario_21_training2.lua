...
function createHumanBeamShip(posx, posy, arc)
	return {CpuShip():setFaction("Human Navy"):setTemplate(" Hathcock"):setPosition(posx, posy):setRotation(arc):orderIdle()}
end

function createHumanMissileShip(posx, posy, arc)
	return {CpuShip():setFaction("Human Navy"):setTemplate(" Piranha M5P"):setPosition(posx, posy):setRotation(arc):orderIdle()}
end

function createHumanMineShip(posx, posy, arc)
	return {CpuShip():setFaction("Human Navy"):setTemplate(" Nautilus"):setPosition(posx, posy):setRotation(arc):orderIdle()}
end

function createHumanScoutShip(posx, posy, arc)
	return {CpuShip():setFaction("Human Navy"):setTemplate(" Adder MK7"):setPosition(posx, posy):setRotation(arc):orderIdle()}
end
