-- Name: Escort
-- Type: Mission
-- Description: Close Combat Mission
---
--- Objective: Defend your mothership against enemy fighters and destroy the enemy carrier.
---
--- Description:
--- In this mission you will face different armed oppenents that you must destroy one by one. The difficulty will start low and will increase slowly with every destroyed enemy squadron.
---
...
In this mission you will practise your abilities with a Hathcock battlecruiser.
