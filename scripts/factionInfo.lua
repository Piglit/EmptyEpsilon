...
iu = FactionInfo():setName("Interplanetary Union"):setLocaleName(_("Interplanetary Union"))
iu:setGMColor(255, 255, 255)
...
iu:setEnemy(kraylor)
iu:setEnemy(GITM)
iu:setFriendly(human)

colonists = FactionInfo():setName("Colonists"):setLocaleName(_("Colonists"))
colonists:setGMColor(128, 128, 128)
colonists:setDescription(_([[The colonists of the warkien cluster. Not a real faction, but some idependent miners, researchers and other adventurers.]]))
colonists:setEnemy(Hive)
colonists:setEnemy(exuari)
colonists:setEnemy(kraylor)
colonists:setEnemy(GITM)
colonists:setFriendly(iu)
colonists:setFriendly(human)

criminals = FactionInfo():setName("Criminals"):setLocaleName(_("Criminals"))
criminals:setGMColor(255, 0, 0)
criminals:setDescription(_([[Not a faction per se, but outlaws and fugitives. United by a common enemy, also known as authorities.]]))
criminals:setEnemy(human)
criminals:setEnemy(iu)
criminals:setEnemy(Hive)
criminals:setEnemy(exuari)
criminals:setEnemy(kraylor)
criminals:setEnemy(GITM)

manuals = FactionInfo():setName("Cultists"):setLocaleName(_("Cultists"))
manuals:setGMColor(255, 255, 255)
manuals:setDescription(_([[The Cult of the Manual]]))
manuals:setEnemy(Hive)
manuals:setEnemy(exuari)
manuals:setEnemy(kraylor)
manuals:setEnemy(GITM)
manuals:setEnemy(criminals)
manuals:setFriendly(iu)
manuals:setFriendly(colonists)
manuals:setFriendly(human)
