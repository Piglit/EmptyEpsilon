...
---
--- Your ship is a warp-driven Cinderella Escort Cruiser - a cruiser with great beam power but few missiles.
---
...
-- secondary design goal: Test and example for script_formations
-- TODO: localisation
...
function createPlayerShip()
    local ship = PlayerSpaceship():setTemplate("Cinderella"):setFaction("Human Navy")
    return ship
end
