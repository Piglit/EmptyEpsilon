...
function customElements:addCustomButton(player_ship, operator, name, caption, callback, index)
    for idx, station in ipairs(self:operatorPositions(operator)) do
        player_ship:addCustomButton(station, name..station, caption, callback, index)
    end
end
...
function customElements:addCustomInfo(player_ship, operator, name, caption, index)
    for idx, station in ipairs(self:operatorPositions(operator)) do
        player_ship:addCustomInfo(station, name..station, caption, index)
    end
end
