...
Keys::Keys() :
    ...
    helms_turn_left("HELMS_TURN_LEFT", {"Left", "-joy:0:axis:0", "-gamecontroller:0:axis:leftx"}),
    helms_turn_right("HELMS_TURN_RIGHT", {"Right", "joy:0:axis:0", "gamecontroller:0:axis:leftx"}),
    ...
    helms_dock_action("HELMS_DOCK_ACTION", {"D", "joy:0:button:4"}),
    ...
    helms_combat_left("HELMS_COMBAT_LEFT", "A"),
    helms_combat_right("HELMS_COMBAT_RIGHT", "D"),
    ...
    weapons_fire_tube{{
        {"WEAPONS_FIRE_TUBE1", {"Keypad 1", "Space", "joy:0:button:1"}},
        {"WEAPONS_FIRE_TUBE2", {"Keypad 2", "Space", "joy:0:button:1"}},
        {"WEAPONS_FIRE_TUBE3", {"Keypad 3", "Space", "joy:0:button:1"}},
        {"WEAPONS_FIRE_TUBE4", {"Keypad 4", "Space", "joy:0:button:1"}},
        {"WEAPONS_FIRE_TUBE5", {"Keypad 5", "Space", "joy:0:button:1"}},
        {"WEAPONS_FIRE_TUBE6", {"Keypad 6", "Space", "joy:0:button:1"}},
        {"WEAPONS_FIRE_TUBE7", {"Keypad 7", "Space", "joy:0:button:1"}},
        {"WEAPONS_FIRE_TUBE8", {"Keypad 8", "Space", "joy:0:button:1"}},
        {"WEAPONS_FIRE_TUBE9", {"Keypad 9", "Space", "joy:0:button:1"}},
        {"WEAPONS_FIRE_TUBE10"},
        {"WEAPONS_FIRE_TUBE11"},
        {"WEAPONS_FIRE_TUBE12"},
        {"WEAPONS_FIRE_TUBE13"},
    ...
    weapons_enemy_next_target("WEAPONS_TARGET_NEXT_ENEMY", {"X", "joy:0:button:2"}),
    weapons_next_target("WEAPONS_TARGET_NEXT", "Y"),
    weapons_toggle_shields("WEAPONS_SHIELDS_TOGGLE", {"S", "joy:0:button:3"}),
