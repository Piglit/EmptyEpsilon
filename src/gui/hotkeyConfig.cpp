...
Keys::Keys() :
    ...
    weapons_select_ion("WEAPONS_SELECT_ION"),
    weapons_load_tube{{
        {"WEAPONS_LOAD_TUBE1"},
        {"WEAPONS_LOAD_TUBE2"},
        {"WEAPONS_LOAD_TUBE3"},
    ...
    engineering_select_system{
        ...
        {"ENGINEERING_SELECT_SYSTEM_COMMUNICATION"},
        {"ENGINEERING_SELECT_SYSTEM_HANGAR"},
        {"ENGINEERING_SELECT_SYSTEM_BRIDGE"},
        {"ENGINEERING_SELECT_SYSTEM_AIRLOCK"},
    },
    ...
    engineering_set_power_for_system{
        ...
        {"ENGINEERING_SET_SYSTEM_POWER_COMMUNICATION"},
        {"ENGINEERING_SET_SYSTEM_POWER_HANGAR"},
        {"ENGINEERING_SET_SYSTEM_POWER_BRIDGE"},
        {"ENGINEERING_SET_SYSTEM_POWER_AIRLOCK"},
    },
    engineering_set_coolant_for_system{
        ...
        {"ENGINEERING_SET_SYSTEM_COOLANT_COMMUNICATION"},
        {"ENGINEERING_SET_SYSTEM_COOLANT_HANGAR"},
        {"ENGINEERING_SET_SYSTEM_COOLANT_BRIDGE"},
        {"ENGINEERING_SET_SYSTEM_COOLANT_AIRLOCK"},
    },
    ...
    tutorial_next("TUTORIAL_NEXT", "Tab"),
...
void Keys::init()
{
    ...
    weapons_select_ion.setLabel(tr("hotkey_menu", "Weapons"), tr("hotkey_Weapons", "Select Ion"));
