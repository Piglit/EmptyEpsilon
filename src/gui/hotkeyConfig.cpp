...
Keys::Keys() :
    ...
    pause("PAUSE", "P"),
    help("HELP", "F1"),
    escape("ESCAPE", {"Escape", "Home", "AC Back"}),
    ...
    //Main screen
    mainscreen_forward("MAINSCREEN_FORWARD"),
    mainscreen_left("MAINSCREEN_LEFT"),
    mainscreen_right("MAINSCREEN_RIGHT"),
    mainscreen_back("MAINSCREEN_BACK"),
    mainscreen_target("MAINSCREEN_TARGET"),
    mainscreen_tactical_radar("MAINSCREEN_TACTICAL"),
    mainscreen_long_range_radar("MAINSCREEN_LONG_RANGE"),
    mainscreen_first_person("MAINSCREEN_FIRST_PERSON", "F"),

    //helms
    helms_increase_impulse("HELMS_IMPULSE_INCREASE", {"Up", "gamecontroller:0:axis:lefty"}),
    helms_decrease_impulse("HELMS_IMPULSE_DECREASE", {"Down", "-gamecontroller:0:axis:lefty"}),
    helms_set_impulse("HELMS_SET_IMPULSE", "-joy:0:axis:2"),
    helms_zero_impulse("HELMS_IMPULSE_ZERO", "End"),
    helms_max_impulse("HELMS_IMPULSE_MAX", "PageUp"),
    helms_min_impulse("HELMS_IMPULSE_MIN", "PageDown"),
    helms_turn_left("HELMS_TURN_LEFT", {"Left", "-joy:0:axis:0", "-gamecontroller:0:axis:rightx"}),
    helms_turn_right("HELMS_TURN_RIGHT", {"Right", "joy:0:axis:0", "gamecontroller:0:axis:rightx"}),
    helms_warp0("HELMS_WARP0", "Keypad 0"),
    helms_warp1("HELMS_WARP1"),
    helms_warp2("HELMS_WARP2"),
    helms_warp3("HELMS_WARP3"),
    helms_warp4("HELMS_WARP4"),
    helms_increase_warp("HELMS_WARP_INCREASE", "Keypad +"),
    helms_decrease_warp("HELMS_WARP_DECREASE", "Keypad -"),
    helms_dock_action("HELMS_DOCK_ACTION", {"D", "joy:0:button:4", "joy:0:button:7"}),
    helms_dock_request("HELMS_DOCK_REQUEST"),
    helms_dock_abort("HELMS_DOCK_ABORT"),
    helms_undock("HELMS_UNDOCK"),
    helms_increase_jump_distance("HELMS_JUMP_INCREASE", "Keypad +"),
    helms_decrease_jump_distance("HELMS_JUMP_DECREASE", "Keypad -"),
    helms_execute_jump("HELMS_JUMP_EXECUTE", "Keypad Enter"),
    helms_combat_left("HELMS_COMBAT_LEFT", {"A", "-joy:0:axis:6"}),
    helms_combat_right("HELMS_COMBAT_RIGHT", {"D", "joy:0:axis:6"}),
    helms_combat_boost("HELMS_COMBAT_BOOST", "W"),

    //weapons
    weapons_select_homing("WEAPONS_SELECT_HOMING", {"1", "gamecontroller:0:button:dpup"}),
    weapons_select_nuke("WEAPONS_SELECT_NUKE", {"2", "gamecontroller:0:button:back"}),
    weapons_select_mine("WEAPONS_SELECT_MINE", {"3", "gamecontroller:0:button:dpdown"}),
    weapons_select_emp("WEAPONS_SELECT_EMP", {"4", "gamecontroller:0:button:dpright"}),
    weapons_select_hvli("WEAPONS_SELECT_HVLI", {"5", "gamecontroller:0:button:dpleft"}),
    weapons_load_tube{{
        {"WEAPONS_LOAD_TUBE1", {"joy:0:button:12", "gamecontroller:0:button:rightshoulder"}},
        {"WEAPONS_LOAD_TUBE2", {"joy:0:button:13", "gamecontroller:0:button:leftshoulder"}},
        {"WEAPONS_LOAD_TUBE3", "joy:0:button:14"},
        {"WEAPONS_LOAD_TUBE4"},
        {"WEAPONS_LOAD_TUBE5"},
        {"WEAPONS_LOAD_TUBE6"},
        {"WEAPONS_LOAD_TUBE7"},
    ...
    weapons_unload_tube{{
        {"WEAPONS_UNLOAD_TUBE1", "gamecontroller:3:button:a"},
        {"WEAPONS_UNLOAD_TUBE2", "gamecontroller:3:button:x"},
    ...
    weapons_fire_tube{{
        {"WEAPONS_FIRE_TUBE1", {"Keypad 1", "Space", "joy:0:button:0", "gamecontroller:0:axis:righttrigger"}},
        {"WEAPONS_FIRE_TUBE2", {"Keypad 2", "Space", "joy:0:button:1", "gamecontroller:0:axis:lefttrigger"}},
        {"WEAPONS_FIRE_TUBE3", {"Keypad 3", "Space"}},
        {"WEAPONS_FIRE_TUBE4", {"Keypad 4", "Space"}},
        {"WEAPONS_FIRE_TUBE5", {"Keypad 5", "Space"}},
        {"WEAPONS_FIRE_TUBE6", {"Keypad 6", "Space"}},
        {"WEAPONS_FIRE_TUBE7", {"Keypad 7", "Space"}},
        {"WEAPONS_FIRE_TUBE8", {"Keypad 8", "Space"}},
        {"WEAPONS_FIRE_TUBE9", {"Keypad 9", "Space"}},
        {"WEAPONS_FIRE_TUBE10"},
        {"WEAPONS_FIRE_TUBE11"},
        {"WEAPONS_FIRE_TUBE12"},
        {"WEAPONS_FIRE_TUBE13"},
    ...
    weapons_enemy_next_target("WEAPONS_TARGET_NEXT_ENEMY", {"X", "joy:0:button:3", "gamecontroller:3:button:y"}),
    weapons_next_target("WEAPONS_TARGET_NEXT", "Y"),
    weapons_toggle_shields("WEAPONS_SHIELDS_TOGGLE", {"S", "joy:0:button:2", "gamecontroller:3:button:b"}),
    ...
    //Science
    science_scan_object("SCIENCE_SCAN_OBJECT", "C"),
