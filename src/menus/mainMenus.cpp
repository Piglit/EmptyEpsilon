...
MainMenu::MainMenu()
{
    ...
    (new GuiLabel(this, "CREDITS12a", "Esga ship set (https://sketchfab.com/feivelyn)", 18))->setAlignment(sp::Alignment::CenterRight)->setPosition(-50, y, sp::Alignment::TopRight)->setSize(0, 18); y += 18;
    y += 10;
    ...
    (new GuiButton(this, "", "TO DA GM!", [this]() {
        ...
        if (game_server)
        {
            gameGlobalInfo->startScenario("scenario_99_vf.lua");
