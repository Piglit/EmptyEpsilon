...
MainMenu::MainMenu()
{
    ...
    (new GuiLabel(this, "VERSION", tr("Credits", "Skystrike Version: {version}").format({{"version", string(VERSION_NUMBER)}}), 20))->setPosition(0, title_y + logo_size, sp::Alignment::TopCenter)->setSize(0, 20);
