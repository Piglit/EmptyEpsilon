...
CampaignScenarioSelectionScreen::CampaignScenarioSelectionScreen()
{
    ...
    CampaignScenarioSelectionScreen();
...
void CampaignScenarioSelectionScreen::loadScenarioList()
{
...
ScenarioSelectionScreen::ScenarioSelectionScreen()
{
    ...
    GuiElement* left_panel = new GuiElement(container, "");
    left_panel->setPosition(0, 20, sp::Alignment::TopCenter)->setSize(550, GuiElement::GuiSizeMax)->setAttribute("layout", "horizontal");
    GuiElement* right_panel = new GuiElement(container, "");
    right_panel->setPosition(0, 20, sp::Alignment::TopCenter)->setSize(550, GuiElement::GuiSizeMax)->setAttribute("layout", "horizontal");
    ...
    (new GuiLabel(row, "VARIATION_LABEL", tr("Variation: "), 30))->setAlignment(sp::Alignment::CenterRight)->setSize(250, GuiElement::GuiSizeMax);
...
*/
    ...
    (new GuiLabel(ship_row, "SHIP_LABEL", tr("ship type: "), 30))->setAlignment(sp::Alignment::CenterRight)->setSize(250, GuiElement::GuiSizeMax);
...
{
    LOG(INFO) << "starting proxy to " << proxy_addr;
    disconnectFromServer(); // Test if socket is released immediately
    PreferencesManager::set("proxy_addr", proxy_addr);
