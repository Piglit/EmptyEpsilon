...
MissileWeaponData missile_data[MW_Count] =
{
    ...
    MissileWeaponData(2000.0f,  0.f, 1.0f, glm::u8vec4(255, 0, 0, 255), 0.0, "sfx/laser_fire.wav"),/*MW_Laser Red*/
    MissileWeaponData(2000.0f,  0.f, 1.0f, glm::u8vec4(0, 255, 0, 255), 0.0, "sfx/laser_fire.wav"),/*MW_Laser Green*/
};
