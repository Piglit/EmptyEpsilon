...
MissileWeaponData missile_data[MW_Count] =
{
    ...
    MissileWeaponData(2000.0f,  0.f, 1.0f, glm::u8vec4(255, 0, 0, 255), 0.0, "sfx/laser_red.wav"),/*MW_Laser Red*/
    MissileWeaponData(2000.0f,  0.f, 1.0f, glm::u8vec4(0, 255, 0, 255), 0.0, "sfx/laser_tie_orig.wav"),/*MW_Laser Green*/
    MissileWeaponData(1500.0f,  0.f, 1.0f, glm::u8vec4(0, 0, 255, 255), 0.0, "sfx/laser_ion.wav"),/*MW_IonMissile*/
};
